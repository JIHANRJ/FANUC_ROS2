    ...
    entry_points={
        'console_scripts': [
            ...
            'pick_place = fanuc_tools.legacy.pick_place:main',
                'move_joint = fanuc_tools.motion.nodes.move_joint:main',
                'modular_joint_demo = fanuc_tools.motion.demos.modular_joint_demo:main',
                'modular_speed_demo = fanuc_tools.motion.demos.modular_speed_demo:main',
                'modular_cartesian_demo = '
                'fanuc_tools.motion.demos.modular_cartesian_demo:main',
                'speed_scaling = fanuc_tools.motion.nodes.speed_scaling:main',
                'collaborative_speed = fanuc_tools.motion.nodes.collaborative_speed:main',
                'move_cartesian = fanuc_tools.motion.nodes.move_cartesian:main',
